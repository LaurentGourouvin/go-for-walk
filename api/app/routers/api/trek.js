...
/**
  ...
  * @property {array<file>} pictures - trek pictures
...
/**
     ...
     */
  .post(validate('body', createSchema), tokenController(), upload.array('pictures', 6), controllerHandler(trekController.createTrek));
